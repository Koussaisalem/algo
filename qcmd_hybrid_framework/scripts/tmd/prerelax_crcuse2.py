#!/usr/bin/env python3
"""
Fast xTB Pre-Relaxation for CrCuSe₂ Candidate
=============================================
...
OUTPUT_FILE = "dft_validation/priority/CrCuSe2_prerelaxed.xyz"
TRAJECTORY_FILE = "dft_validation/priority/CrCuSe2_prerelax.traj"
# ---------------------

def main():
    print("=" * 70)
    print("🔬 Phase 1: xTB Pre-Relaxation for CrCuSe₂")
    print("=" * 70)
    print(f"\nInput:  {INPUT_FILE}")
    ...
    print("=" * 70)
    print("\nNext step:")
    print("  python scripts/tmd/05_validate_with_dft.py dft_validation/priority/CrCuSe2_prerelaxed.xyz --mode fast --single-point")
    print()
